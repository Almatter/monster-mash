...
export const SUSTAIN_TEXT:Record<string,string>={titan:'Shattering ten foes heals 30 and grants 40–80 barrier based on Momentum (max 150, 8s). Moving builds Momentum and reinforces barrier; standing still lets it fade.',calamity:'A 20+ multikill restores up to 320 ward (max 480, 12s). Once every 2.5s. Rebuild it with well-placed spells.',overlord:'Controlled and summoned kills siphon 11 health each, limited to 52 health per second. Keep servants fighting.',devourer:'Devour heals up to 35% maximum health per cast. Frenzy kills heal 8–14 each, capped at 25–65% maximum health per cast as Release rises. Every 20 Frenzy kills grants 1.5–2.5s of 40–60% damage reduction.',sovereign:'Successful Devour kills heal up to 40% maximum health per cast. Feeding Rage boosts damage and reduces incoming damage by 25% for six seconds.'};
