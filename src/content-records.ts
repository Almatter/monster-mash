...
export const FEAT_CONDITIONS:Record<string,string>={extinction:'Slay 100 enemies within 5 seconds.',overkill:'Hit 20 enemies for at least four times their remaining health in one activation.',chain:'Slay 8 enemies through knockback collisions in one chain.',apex:'Devour an elite in one activation.',untouchable:'Slay 150 enemies without taking damage.',massacre:'Slay 40 enemies in one attack or activation.'};
