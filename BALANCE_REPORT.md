# Monster Mash v3 balance report
...
- Devourer: Devour feeds for up to 35% max HP per cast; Frenzy kills heal up to 25% max HP total per activation. Lunge handles escape/re-entry, execution prioritizes wounded elites. Final runs healed 7,960-13,405. Late dense contact between feeding windows is fatal. Saving and aiming feeding matters; neither effect restores health without kills.
